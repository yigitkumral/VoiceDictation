...
**Commit kurali:** Commit yapmadan **once mutlaka kullanicidan onay al** (kullanicinin global AGENTS.md kurali).

---

## 0.5) **AGENT'A:** Mac'te Ilk Session Aciliyorsa

Yigit Mac'te yeni Codex session actiginda **ilk konusmada** proaktif hatirlat: son Mac dogrulamasi **26 Nisan 2026** (CHANGELOG'da `macOS test paketi`). O tarihten sonraki 22-23 Mayis fix paketleri (halusinasyon B1-B4, yeni klasor duzeni, Lecture WAV dump, LIVE gecici dosya, stop'ta isim dialog) **Windows'ta dogrulandi, Mac'te dogrulanmadi**.
